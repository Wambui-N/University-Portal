    ...
    <table class="table table-striped-columns">
        ...
        <tbody>
            @foreach ($units as $unit)
                ...
                <!-- Edit unit Modal -->
                <div class="modal fade" id="editModal{{ $unit->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="editModalLabel{{ $unit->id }}" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('units.update', $unit->id) }}" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="name" type="text" value="{{ old('name', $unit->name ?? '') }}"
                                            class="form-control" id="validationCustom01" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Teacher</label>
                                        <input name="name" type="text" value="{{ old('ADM', $unit->ADM ?? '') }}"
                                            class="form-control" id="validationCustom01" required>
                                    </div>
                                    <div class="col-md-12">
